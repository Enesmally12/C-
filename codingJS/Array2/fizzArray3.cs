// namespace cSharp_withMrMike.fizzArray3;
...
// {
//     public static string[] fizzArr(int num1, int num2)
//     {
//         int length = num2-num1;
//         string[] newArray = new string[num2-num1]; 

//         for(int i=num1; i<newArray.Length; i++)
//         {
//             newArray[i] = $"{i}"; 
//         }
//         return newArray;
