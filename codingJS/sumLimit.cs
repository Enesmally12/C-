// namespace cSharp_withMrMike.sumLimit;
...
// {
//         public void limit(int a, int b)
//     {
//         int numAB =  a + b;
//         string numA = a.ToString();
//         string numB = b.ToString();
//         string sumIt = numAB.ToString();

//         if(numA.Length == sumIt.Length)
//         {
//             Console.WriteLine($"{numAB}");
//         }
//         else if(sumIt.Length > numA.Length)
//         {
//             Console.WriteLine($"{a}");
//         }
//     }
